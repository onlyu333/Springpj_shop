   ...
   <div id="main">
      ...
      <section>
         ...
         <div id="center">
            ...
            <div id="today">
               <li><a href="#"> <!-- <img src="pick3.jpg"> -->
               </a></li> <br>
               <li><a id="pick" href="#">더우면 벗으면되지<br> 요시다케 신스케| 주니어
                     김영사
               </a></li>
            </div>
            <div id="today2">
               <li><a href="#"> <!-- <img src="pick2.jpg"> -->
               </a></li> <br>
               <li><a id="pick" href="#">DO it!웹표준의 정석<br> 고경희|
                     이지스퍼블리싱
               </a></li>
            </div>
            <div id="today3">
            ...
            <form id="loginForm" method="get">
               ...
               <c:if test="${member == null }">
                  <div class="d-grid gap-2">
                     <button type="button" class="loginButton btn btn-primary">로그인</button>
                  </div>
               ...
               <div class="login_success_area">
                  <c:if test="${ member != null }">
                     <c:if test="${member.getMid() eq 'admin'}">
                        <span><a href="admin">관리자 페이지</a></span>
                        <br>
                     </c:if>
